...
const features = [
  ...
  },
  {
    ...
    emoji: '',
    title: 'Analyse IA',
    text: 'Une synthèse Claude sur chaque bien : points forts, points faibles, cohérence du prix.'
  }
]
  ...
  <div class="min-h-screen bg-white text-ink antialiased">
    <header class="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-hairline-soft">
      <nav class="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          <a href="#" class="hidden sm:inline text-sm font-medium hover:text-slate transition">Se connecter</a>
    ...
    <section class="relative bg-brand overflow-hidden">
      <div class="mx-auto max-w-6xl px-6 pt-20 pb-24 md:pt-28 md:pb-32 text-center"> 
        <h1 class="mx-auto max-w-3xl text-5xl md:text-7xl font-bold tracking-tight leading-[1.05] text-ink-deep">
          Tous tes biens.<br>
          <span class="relative inline-block">
            <span class="relative z-10">Un seul endroit.</span>
            <span class="absolute inset-x-0 bottom-1 h-4 bg-brand -z-0 -skew-y-1"></span>
          </span>
        </h1>
        <p class="mx-auto mt-6 max-w-xl text-lg text-slate leading-relaxed">
        ...
        <div class="mx-auto mt-10 flex max-w-xl flex-col sm:flex-row gap-3">
          <input
            type="text"
          ...
          />
          <button class="h-12 rounded-full bg-ink text-white text-sm font-medium px-7 hover:bg-black transition whitespace-nowrap">
            Ajouter le bien →
          </button>
        </div>
        <p class="mt-3 text-xs text-ink">Gratuit. Sans carte bancaire.</p>
      </div>

      <!-- soft pastel blobs -->
      <div class="pointer-events-none absolute -top-24 -left-24 size-72 rounded-full bg-teal/40 blur-3xl"></div>
      <div class="pointer-events-none absolute top-10 -right-20 size-72 rounded-full bg-coral/40 blur-3xl"></div>
    </section>
    ...
    <section id="sources" class="border-y border-hairline-soft bg-surface-soft">
      <div class="mx-auto max-w-6xl px-6 py-10">
        ...
        <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
          <span v-for="s in sources" :key="s" class="text-lg font-semibold text-steel">{{ s }}</span>
        </div>
      </div>
    </section>
    ...
    <section id="features" class="mx-auto max-w-6xl px-6 py-24">
      ...
      <div class="grid sm:grid-cols-2 gap-5">
        <div
          v-for="f in features"
          :key="f.title"
          class="rounded-[28px] border border-hairline-soft p-8 hover:shadow-lg hover:-translate-y-1 transition"
        >
    ...
    <section id="how" class="bg-surface">
      <div class="mx-auto max-w-6xl px-6 py-24">
        <h2 class="text-center text-4xl md:text-5xl font-bold tracking-tight text-ink-deep mb-16">
    ...
    <section class="mx-auto max-w-6xl px-6 py-24">
      <div class="relative overflow-hidden rounded-feature bg-brand px-8 py-16 md:py-20 text-center">
        ...
        <a href="#" class="mt-8 inline-block rounded-full bg-ink text-white font-medium px-8 py-3.5 hover:bg-black transition">
